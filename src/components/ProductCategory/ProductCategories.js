            ...
            <div className="container px-5 py-8 mx-auto">
                ...
                <div className="outline-none-div flex flex-wrap -m-4">
                    ...
                    className="outline-none-div p-4 sm:w-1/2 lg:w-1/3">
                        <Link to="/telephones_Page" classNameName='outline-none-div'>
                            <div className="outline-none-div h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                            <img className="lg:h-72 md:h-48 w-full 
                                            object-cover object-center" 
                            src={image1} alt="blog" />
                            <div className="outline-none-div p-6 hover:bg-indigo-700 hover:text-white transition duration-300 ease-in">
                                <h1 className="outline-none-div text-2xl font-semibold mb-3">TelePhone System Products</h1>
                                <p className="outline-none-div leading-relaxed mb-3">
                                ...
                                <div className="outline-none-div flex items-center flex-wrap">
                                <a className="outline-none-div text-indigo-300 inline-flex items-center md:mb-2 lg:mb-0 no-underline hover:no-underline">
                                    See More
                    ...
                    viewport={{ once: true, amount: 0.5 }}
                     className="outline-none-div p-4 sm:w-1/2 lg:w-1/3">
                        <Link to="/OnPromise_Page" classNameName='outline-none-div'>
                    ...
                    className="p-4 sm:w-1/2 lg:w-1/3">
                        <Link to="/cloud_Page" classNameName='outline-none-div'>
                            <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                                <img className="lg:h-72 md:h-48 w-full object-cover object-center"
                                    src={image3} alt="blog" />
                                <div className="p-6 hover:bg-indigo-700 hover:text-white transition duration-300 ease-in">

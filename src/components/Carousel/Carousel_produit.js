...
function Carousel_produit() {
    ...
    const fetchImages = async () => {
      try {
        const response = await fetch("/api/public/carousel_prod/list");
        if (response.ok) {
    ...
    return (
      ...
      className='max-w-[1900px] my-24 h-[780px] w-full relative group'>
...
export default Carousel_produit